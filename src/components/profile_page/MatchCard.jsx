    ...
    return (
        <Box sx={{
                ...
                <Box sx={{display: "flex"}}>
                    <InternetImage
                        ...
                        extraSx={{
                            ...
                            outlineOffset: "-2px", // pushes the outline inward
                        }}
                    />
                    ...
                    {selfPerformance?.itemIds?.map((itemId) => (
                        <>
                            {itemId !== 0 ? <InternetImage
                                ...
                                borderRadius={"6px"}
                            /> : <Box
                                sx={{height: miniImgSize, width: miniImgSize, backgroundColor: "bg.3", borderRadius: "6px"}}/>
                            }
                            <Box width={gapSize}></Box>
                        </>
                    ))}
            ...
            <Box sx={{
                ...
                <Box height={"4px"}></Box>
                <Typography sx={{color: selfPerformance?.mvp ? "rate.1" : "content.1", fontSize: "12px", fontWeight: "500"}}>
                    {placementToDisplayString(
