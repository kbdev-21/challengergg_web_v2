        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
            <Box sx={{
                ...
                <Box>
                    <Box sx={{display: "flex"}}>
                        <InternetImage
                            url={getChampionAvatarUrl(builds[currentBuildIndex].championName, currentPatch)}
                            height={"100px"}
                            width={"100px"}
                            borderRadius={"20px"}
                            extraSx={{
                        ...
                        <Box>
                            <Box sx={{display: "flex", alignItems: "center"}}>
                                <Typography sx={{color: "content.1", fontSize: "26px", fontWeight: "500"}}>
                                    {builds[currentBuildIndex].championDisplayName}
                                </Typography>
                                <Box width={"10px"}></Box>
                                <Typography sx={{color: "content.2", fontSize: "14px", fontWeight: "500"}}>
                                    Build for {positionTextFormatMap[builds[currentBuildIndex].position]}, Elite Tier, Patch {currentPatch?.split(".").slice(0, 2).join(".")}
                                </Typography>
                            </Box>
                            <Box height={"12px"}></Box>
                            <Box sx={{display: "flex"}}>
